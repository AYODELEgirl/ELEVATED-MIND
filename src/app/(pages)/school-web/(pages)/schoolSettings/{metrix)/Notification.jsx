...
export default function Notification() {
  ...
  const handleChange = (key) => {
    setEnabled((prevState) => ({
      ...prevState,
      [key]: !prevState[key], // Toggle the value of the switch
    }));
  };
  ...
  return (
    <>
      <div>
        ...
        <div className="flex gap-5 mb-10 px-2">
          ...
          <div className={"flex flex-col gap-5"}>
            ...
            <div className={"flex gap-3"}>
              ...
              <div className="flex flex-col gap-1">
                <p>Upcoming donations</p>
                <p className={"text-[#667185] text-[12px]"}>Receive notifications for every upcoming donation</p>
              </div>
            </div>
            <div className={"flex gap-3"}>
              <div>
          ...
          <div className={"flex flex-col gap-5"}>
            <div className={"flex gap-3"}>
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className={"text-[#667185] text-[12px] "}>Receive notifications via email</p>
              </div>
            </div>
            <div className={"flex gap-3"}>
              <div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className={"text-[#667185] text-[12px]"}>Get real-time updates and alerts directly on your phone</p>
              </div>
            </div>
            <div className={"flex gap-3"}>
              <div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className={"text-[#667185] text-[12px]"}>Receive notification via SMS</p>
              </div>
            </div>
          </div>
        </div>
